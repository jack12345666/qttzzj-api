...
@Data
public class TBuildingLeaseAddDTO {
    ...
    @NotNull(message = "区域序号不能为空")
    @ApiModelProperty(value = "区域序号, 多个用逗号隔开", required = true)
    private String areaId;

    @NotNull(message = "区域名称不能为空")
    @ApiModelProperty(value = "区域名称, 多个用逗号隔开", required = true)
    ...
    @ApiModelProperty(value = "多个附件将路径用,隔开")
