...
public class StringCheckUtil {
    ...
    public static void verifyPassword(String password){
        if(!checkPasswordLength(password,"6","20")
            ...
            throw new BaseException("密码强度不符合要求[6~20位任意数字、字母]");
        }
    }
	...
	public static void verifyUsername(String username){
	    if(!checkPasswordLength(username,"3","10")){
	        throw new BaseException("用户名格式不正确[3~10位任意字符]");
        }
    }
